...
export const CameraFlipIcon = ({ isFlipping }: { isFlipping: boolean }) => (
    <svg {...iconProps} width="28" height="28" className={cn(isFlipping && 'animate-spin')}>
...
export const FlashOnIcon = () => (
    <svg {...iconProps} width="24" height="24" viewBox="0 0 24 24">
...
export const FlashAutoIcon = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" />
        <path d="M18.57 2.43A3.28 3.28 0 0 0 16.2 3.8l-1.6 2.8" />
        <path d="M18.57 7.57A3.28 3.28 0 0 0 20.8 6.2l1.6-2.8" />
    </svg>
);
...
export const CameraIcon = ({ isActive }: { isActive: boolean }) => (
...
export const SearchIcon = ({ active, size = 22 }: { active: boolean, size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={cn(active ? 'text-blue-400' : 'text-gray-400')}>
    <circle cx="11" cy="11" r="8"></circle>
    <line x1="21" y1="21" x2="16.65" y2="16.65"></line>
  </svg>
);

export const MapIcon = ({ active, size = 22 }: { active: boolean, size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={cn(active ? 'text-green-400' : 'text-gray-400')}>
...
export const GalleryIcon = ({ isActive }: { isActive: boolean }) => (
    <svg width="28" height="28" viewBox="0 0 24 24" fill={isActive ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
